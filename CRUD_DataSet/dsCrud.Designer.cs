...
namespace CRUD_DataSet {
    ...
    public partial class dsCrud : global::System.Data.DataSet {
        ...
        public partial class PersonaDataTable : global::System.Data.TypedTableBase<PersonaRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public PersonaRow AddPersonaRow(string nombre, string apellido, int edad) {
...
namespace CRUD_DataSet.dsCrudTableAdapters {
    ...
    public partial class PersonaTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [Persona] WHERE (([id] = @Original_id) AND ([nombre] = @Original_nomb" +
                "re) AND ([apellido] = @Original_apellido) AND ([edad] = @Original_edad))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [Persona] ([nombre], [apellido], [edad]) VALUES (@nombre, @apellido, " +
                "@edad);\r\nSELECT id, nombre, apellido, edad FROM Persona WHERE (id = SCOPE_IDENTI" +
                "TY())";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [Persona] SET [nombre] = @nombre, [apellido] = @apellido, [edad] = @edad WHERE (([id] = @Original_id) AND ([nombre] = @Original_nombre) AND ([apellido] = @Original_apellido) AND ([edad] = @Original_edad));
SELECT id, nombre, apellido, edad FROM Persona WHERE (id = @id)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::CRUD_DataSet.Properties.Settings.Default.CrudWindowsFormConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[1].CommandText = "INSERT INTO [Persona] ([nombre], [apellido], [edad]) VALUES (@nombre, @apellido, " +
                "@edad);\r\n";
            ...
            this._commandCollection[1].Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@apellido", global::System.Data.SqlDbType.VarChar, 80, global::System.Data.ParameterDirection.Input, 0, 0, "apellido", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
            ...
            this._commandCollection[3].CommandText = "UPDATE Persona set nombre = @nombre, apellido = @apellido, edad = @edad where id " +
                "= @id ";
            ...
            this._commandCollection[3].Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@apellido", global::System.Data.SqlDbType.VarChar, 80, global::System.Data.ParameterDirection.Input, 0, 0, "apellido", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
            ...
            this._commandCollection[4].CommandText = "select * from Persona\r\nwhere id =@id";
        ...
        public virtual int Fill(dsCrud.PersonaDataTable dataTable) {
        ...
        public virtual dsCrud.PersonaDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            dsCrud.PersonaDataTable dataTable = new dsCrud.PersonaDataTable();
        ...
        public virtual int FillBy(dsCrud.PersonaDataTable dataTable, int id) {
        ...
        public virtual dsCrud.PersonaDataTable GetDataById(int id) {
            this.Adapter.SelectCommand = this.CommandCollection[4];
            this.Adapter.SelectCommand.Parameters[0].Value = ((int)(id));
            dsCrud.PersonaDataTable dataTable = new dsCrud.PersonaDataTable();
            this.Adapter.Fill(dataTable);
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(dsCrud.PersonaDataTable dataTable) {
        ...
        public virtual int Delete(int Original_id, string Original_nombre, string Original_apellido, int Original_edad) {
        ...
        public virtual int Update(string nombre, string apellido, int edad, int Original_id, string Original_nombre, string Original_apellido, int Original_edad, int id) {
            if ((nombre == null)) {
                throw new global::System.ArgumentNullException("nombre");
            }
            else {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string nombre, string apellido, int edad, int Original_id, string Original_nombre, string Original_apellido, int Original_edad) {
        ...
        public virtual int Add(string nombre, string apellido, int edad) {
        ...
        public virtual int Edit(string nombre, string apellido, int edad, int id) {
